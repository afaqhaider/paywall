...
/**
 * Same shape as GoogleSignInButton - plain top-level navigation, NOT a
 * fetch call, so the browser can actually leave the page for GitHub's
 * consent screen and come back with a real `code`.
 */
export function GithubSignInButton({ label = "Continue with GitHub" }: { label?: string }) {
  return (
    ...
    >
      <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true" fill="#181717">
